...
//  DynamicKit
//
//  Created by LiveLoadPlayGround on 22/6/2018.
//  Copyright © 2018 LiveLoadPlayGround. All rights reserved.
//
...
- (void)performDylib {
    NSString *libPath = @"/opt/LiveLoad/dylib/LiveLoadPlayGround.framework";
    libPath = [libPath stringByAppendingPathComponent:[NSString stringWithFormat:@"LiveLoadPlayGround_%@", @(self.currentDylibNo)]];
    ...
    NSString *className = [NSString stringWithFormat:@"LiveLoadPlayGround_%@", @(self.currentDylibNo)];
